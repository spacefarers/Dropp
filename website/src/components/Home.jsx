...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <section className="hero">
          <div>
            ...
            <p>
              Dropp keeps your files and snippets within reach across macOS, Windows,
              and the web. Park anything in the cloud-backed dropzone, then drag,
      ...
      <footer>
        <span>© {currentYear} Dropp. Built for makers on every platform.</span>
        <a href="https://github.com/spacefarers/Dropp" rel="noopener noreferrer" target="_blank">github.com/spacefarers/Dropp</a>
      </footer>
    </>
  )
}
